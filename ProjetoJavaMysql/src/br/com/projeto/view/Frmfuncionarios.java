...
public class Frmfuncionarios extends javax.swing.JFrame {
    ...
    private void tbfuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbfuncionariosMouseClicked
        ...
        jftelefonefixo.setText(tbfuncionarios.getValueAt(tbfuncionarios.getSelectedRow(), 8).toString());
        jfcelular.setText(tbfuncionarios.getValueAt(tbfuncionarios.getSelectedRow(), 9).toString());
        txtcep.setText(tbfuncionarios.getValueAt(tbfuncionarios.getSelectedRow(), 10).toString());
        txtend.setText(tbfuncionarios.getValueAt(tbfuncionarios.getSelectedRow(), 11).toString());

...
public class FrmFornecedor extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(12, 12, 12)
                                .addComponent(jfcnpj, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGap(160, 160, 160)
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtfornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 213, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void btpesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btpesquisarActionPerformed
        ...
        String nome = "%" + txtfornecedor.getText() + "%";
        System.out.println("nome capturado" + nome);
        FornecedorDAO dao = new FornecedorDAO();

        List<Fornecedores> lista = dao.PesquisarFornecedor(nome);
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
       ...
       FornecedorDAO dao = new FornecedorDAO();
        ...
        Fornecedores obj = new Fornecedores();
         ...
         System.out.println("frmcnpj"+jfcnpj.getText());
    ...
    private void tbfornecedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbfornecedorMouseClicked
        ...
        //jfrg.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 2).toString());
        jfcnpj.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 2).toString());
        txtemail.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 3).toString());
        jftelefonefixo.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 4).toString());
        jfcelular.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 5).toString());
        txtcep.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 6).toString());
        txtend.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(),7 ).toString());
        txtnumero.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 8).toString());
        txtcomplemento.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 9).toString());
        txtbairro.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 10).toString());
        txtcidade.setText(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 11).toString());
        cbuf.setSelectedItem(tbfornecedor.getValueAt(tbfornecedor.getSelectedRow(), 12).toString());

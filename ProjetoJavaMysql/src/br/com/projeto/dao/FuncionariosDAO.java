...
public class FuncionariosDAO {
    ...
    public void efetuarLogin(String email, String senha) {
        ...
        if(rs.next()){
            ...
            tela1.usuarioLogado1 = rs.getString("nome");
            tela1.usuarioIdLogado1 =rs.getInt("id");
            tela1.setVisible(true);
            String n1=rs.getString("nome");
            System.out.println(""+n1);
            
            Integer i1=rs.getInt("id");
            System.out.println("menu"+i1);
...
String sql ="insert into tb_funcionarios"
  ...
  public void ExcluirFuncionarios(Funcionarios obj){
       ...
       try {
        ...
        public void AlterarFunconarios(Funcionarios obj ){
